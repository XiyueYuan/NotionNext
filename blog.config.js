...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Personal Blog: Asian Chinese insights',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Xlens', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Student | Writer & Journalist', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xlens.online', // 网站地址
...
// START ************网站字体*****************
  ...
  FONT_SANS: [
    // '"LXGW WenKai"',
    '"Times New Roman"', // 将 Times New Roman 作为无衬线字体首选
    '"PingFang SC"',
    '-apple-system',
    'BlinkMacSystemFont',
    '"Hiragino Sans GB"',
  ...
  FONT_SERIF: [
    // '"LXGW WenKai"',
    '"Times New Roman"', // 将 Times New Roman 作为衬线字体首选
    'Bitter',
    '"Noto Serif SC"',
    'SimSun',
    'Times',
  ...
  COMMENT_GISCUS_LANG: process.env.NEXT_PUBLIC_COMMENT_GISCUS_LANG || 'zh-en', // 你的 Giscus 語言 e.g 'en', 'zh-TW', 'zh-CN', 預設 'en'
